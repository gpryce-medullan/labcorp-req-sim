...
if (isset ($_POST["btnSubmit"])) {
 ...
 curl_setopt_array($curl, array(
   ...
   CURLOPT_POSTFIELDS => "<mock>\n<simulate>".$requsitionStatus."</simulate>\n</mock>\n",
   CURLOPT_HTTPHEADER => array(
     "authorization: Basic b25ldG9vbmU6TXB2bW4yNWRFdFJS",
     "cache-control: no-cache",
     "content-type: text/xml",
     "postman-token: 488d342e-00fc-3cef-15b4-8ac25caf4532"
   ),
 ));
...
<html class="no-js" lang="">
  ...
  <?php endif; ?>
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Labcorp Requisition Approval</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <div><a href="https://labcorp-req-sim.herokuapp.com/results.php"> labcorp Results Generator</a> 
        </div><!--/.navbar-collapse -->
      </div>
    </nav>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Labcorp Requisition Approval</h1>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-8">
            ...
            <!-- Multiple Radios -->
            <div class="form-group">
              <label class="col-md-4 control-label" for="RequsitionStatus">Requisition Action</label>
              <div class="col-md-4">
              <div class="radio">
                <label for="RequsitionStatus-0">
                  <input type="radio" name="RequsitionStatus" id="RequsitionStatus-0" value="approve" checked="checked">
                  Approve
                </label>
              </div>
              <div class="radio">
                <label for="RequsitionStatus-1">
                  <input type="radio" name="RequsitionStatus" id="RequsitionStatus-1" value="reject">
                  Reject
                </label>
              </div>
              </div>
